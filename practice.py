...
customer_manager.add_customer("ali", "ali@example.com")
customer_manager.add_customer("farid", "farid@example.com")
customer_manager.add_customer("dilshod", "dilshod@example.com")
